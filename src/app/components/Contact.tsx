        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            {submitted ? (
              <div className="bg-green-100 dark:bg-green-800 border border-green-400 dark:border-green-700 text-green-700 dark:text-green-200 px-4 py-3 rounded relative mb-6">
                <p>Terima kasih! Pesan Anda telah kami terima. Tim kami akan segera menghubungi Anda.</p>
              </div>
            ) : null}
          ...
          >
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
              <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Jam Operasional</h4>
