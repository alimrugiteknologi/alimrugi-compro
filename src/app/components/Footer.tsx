        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-6">
              Mitra teknologi terpercaya untuk solusi digital modern yang membantu bisnis Anda berkembang.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#portfolio" className="text-gray-400 hover:text-white transition-colors">Portofolio</a>
              </li>
              <li>
                <a href="#pricing" className="text-gray-400 hover:text-white transition-colors">Harga</a>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <a href="#services" className="text-gray-400 hover:text-white transition-colors">Website Development</a>
              </li>
              <li>
                <a href="#services" className="text-gray-400 hover:text-white transition-colors">Mobile App Development</a>
              </li>
              <li>
                <a href="#services" className="text-gray-400 hover:text-white transition-colors">Graphic Design</a>
              </li>
              <li>
                <a href="#services" className="text-gray-400 hover:text-white transition-colors">AI Solutions</a>
              </li>
              <li>
                <a href="#services" className="text-gray-400 hover:text-white transition-colors">IT Training</a>
              </li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-gray-400">
              <li>
                Gedung Mitra Digital, Jl. Teknologi Baru No. 123<br />
              ...
              <li>
                <a href="mailto:info@alimrugi.id" className="hover:text-white transition-colors">info@alimrugi.id</a>
              </li>
              <li>
                <a href="https://wa.me/6281234567890" className="hover:text-white transition-colors">WhatsApp: +62 812-3456-7890</a>
              </li>
            </ul>
          </div>
        </div>
